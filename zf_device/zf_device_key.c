...
* @param : void
* @return: void
* @date  : 2024年9月28日16:59:33
* @author: SJX
************************************************/
uint8 Key_IfEnter(void)
{
    if(key_get_state(KEY_4) != KEY_RELEASE || key_get_state(KEY_3) != KEY_RELEASE ||
       key_get_state(KEY_2) != KEY_RELEASE || key_get_state(KEY_1) != KEY_RELEASE )
        return 1;
    else
        return 0;
}
